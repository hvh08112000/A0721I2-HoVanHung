...
public class TennisGame {
    public static String getScore(String player1Name, String player2Name, int playerScore1, int playerScore2) {
        ...
        if (playerScore1 == playerScore2) {
            score = deuce(playerScore1);
        }
        else if (playerScore1 >= 4 || playerScore2 >= 4) {
            score = advantage(playerScore1, playerScore2);
        }
        else {
            for (int i = 1; i < 3; i++) {
                if (i == 1) {
    ...
    private static String advantage(int playerScore1, int playerScore2) {
        String score;
    ...
    private static String deuce(int playerScore1) {
        String score;
        switch (playerScore1) {
            case 0:
                score = "Love-All";
